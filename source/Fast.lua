...
local IdUser_Info = bot.searchPublicChat("PPF22")
...
{
{text = "‹ سورس ناسك ›", url="https://t.me/crvso"},
},
}
...
if text == 'مطور السورس' or text == 'المبرمج' or text == 'المطور' then  
local IdUser_Info = bot.searchPublicChat("PPF22")
if IdUser_Info.id then
local UserInfo = bot.getUser(IdUser_Info.id)
local InfoUser = bot.getUserFullInfo(IdUser_Info.id)
